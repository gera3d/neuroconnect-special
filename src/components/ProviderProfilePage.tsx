...
export function ProviderProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      {/* Featured Reviews Section - Social Proof Showcase */}
      {provider.reviews && provider.reviews.length > 0 && (
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-3 mb-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-lg text-slate-600 font-medium">Verified Google Reviews</p>
                </div>
              </div>
            ...
            {/* Featured Hero Review - The Best One */}
            {provider.reviews[0] && (
              <div className="mb-8 relative">
                <div className="absolute -top-6 -left-6 text-blue-600/10 select-none pointer-events-none">
                  <svg className="h-24 w-24" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                  </svg>
                </div>
                
                <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl p-8 sm:p-12 shadow-2xl border-2 border-blue-100 relative overflow-hidden">
                  {/* Decorative elements */}
                    ...
                    <div className="flex items-center gap-4">
                      <Avatar className="h-14 w-14 border-2 border-white shadow-lg">
                        <AvatarFallback className="bg-gradient-to-br from-blue-600 to-purple-600 text-white text-lg font-bold">
                          {provider.reviews[0].author_name?.split(' ').map(n => n[0]).join('').slice(0, 2) || 'R'}
                        </AvatarFallback>
                      </Avatar>
                      <div>
                        <p className="font-bold text-slate-900 text-lg">
                          {provider.reviews[0].author_name || 'Anonymous'}
                        </p>
                        <p className="text-sm text-slate-600">
                          {provider.reviews[0].relative_time_description || 'Recent review'} · Google User
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            {provider.reviews.length > 1 && (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {provider.reviews.slice(1, 4).map((review, idx) => (
                  <div
                    key={idx}
                    className="bg-white rounded-2xl p-6 shadow-xl border-2 border-slate-100 hover:shadow-2xl hover:scale-105 transition-all duration-300 group"
                  >
                    {/* Star Rating */}
                    ...
                    {/* Review Text */}
                    <p className="text-slate-700 leading-relaxed mb-6 line-clamp-4 group-hover:line-clamp-none transition-all">
                      "{review.text}"
                    </p>
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                      <Avatar className="h-10 w-10 border-2 border-slate-100">
                        <AvatarFallback className="bg-gradient-to-br from-slate-600 to-slate-500 text-white text-sm font-bold">
            ...
            <div className="text-center">
              <Button
                ...
                variant="outline"
                asChild
                className="gap-2 border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-bold text-lg h-14 px-8"
              >
                <a
                  href={provider.url}
                  target="_blank"
